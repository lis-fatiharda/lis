<template>
    <card id="SALT01D01PDF" style="padding: 0">

       <l-div-flex>
        <l-space/>

        <l-div-flex>
            <h4>SATIŞ BELGELERİ RAPORU</h4>
        </l-div-flex>
        ...
        <q-img
            ...
            <div style="padding: 0">
                <q-markup-table dense flat bordered>
                    ...
                    <tbody>
                        <tr v-for="(item, index) in dv.salDocList" :key="index">
        ...
        <template class="footer">
            <div>
                ...
                <l-chip dense outline
                    >Tarih: {{ lis.format(new Date(), "dd.MM.yyyy HH:ss") }}</l-chip
                >
            </div>
        </template>
    </card>
