<template>
    <template v-for="note in dv.lisprddocs.note" :key="note.id">
...
export default {
    ...
    methods: {
        async pushNewNote() {
            let newNote = { ...this.dv.lisprddocs.note[0] };
            ...
            this.dv.lisprddocs.note.push(newNote);
        },
        async removeNote(note) {
            this.dv.lisprddocs.note = [
                ...this.dv.lisprddocs.note.filter(
                    (e) =>
