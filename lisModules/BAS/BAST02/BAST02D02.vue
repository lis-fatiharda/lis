    ...
    <l-card0>
      ...
      <l-card>
        <l-tabs v-model="tab">
          ...
          <l-tab
            name="Malzemeler"
            :label="this.$gl(`Malzemeler`, `Materials`)"
          />
        ...
        <l-tab-panels v-model="tab">
          ...
          <l-tab-panel name="Muhasebe" class="q-gutter-xs row">
            ...
            <l-card style="width: 49%; min-width: 320px">
              ...
              <l-card-section class="row q-gutter-xs">
                ...
                <l-select
                  :label="
                    this.$gl(`Kur Değer Yöntemi`, `Currency Value Method`)
                  "
          ...
          <l-tab-panel name="Malzemeler" class="q-gutter-xs">
            <l-card class="q-gutter-xs q-pa-xs">
              <l-card-section>
                {{ this.$gl("Müşteri Malzemeleri", "Customer Materials") }}
              </l-card-section>
              <q-seperator inset />
            ...
            <l-card class="q-gutter-xs q-pa-xs">
              <l-card-section>
                {{ this.$gl("Tedarikçi Malzemeleri", "Vendor Materials") }}
              </l-card-section>
              <q-seperator inset />
              <template v-for="mat in dv.liscusmats" :key="mat.id">
                <q-markup-table>
