            ...
            <l-card-section>
                <l-div-flex>
                    ...
                    <l-select
                        ...
                        :label="
                            this.$gl(`Malyt. Merk. Gir.`, `Cost Cent. Ent.`)
                        "
                        :options="[
                            { label: this.$gl(`Serbest`, `Free`), value: 0 },
                            {
...
export default {
    ...
    data() {
        return {
            lockKeyParams: {
                ...
                lid: "FINT01",
                lockkey:
                    this.dv.lisaccounts.acctype + this.dv.lisaccounts.account,
            },
        };
    },
    ...
    methods: {
        async btnSave() {
            ...
            this.cancel();
            // await this.$Axios
            //   .post("FINT01/02-btnSave", this.dv)
            //   .then((res) => {
