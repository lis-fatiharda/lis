    ...
    <l-card style="width: 49%; min-width: 320px">
            ...
            <l-card-section class="q-gutter-xs">
              <l-div-flex>
                ...
                <l-input
                  :label="
                    this.$gl(`Malı Gönderen Firma`, `Company Sending Goods`)
                  "
                ...
                >
                  <l-chip
                    ...
                    clickable
                    @click="
                      dv.lispurdocs.isSelectGrc = !dv.lispurdocs.isSelectGrc
                    "
                  >
                    <BAST02D01mini
              ...
              <l-div-flex>
                ...
                >
                  <l-chip
                    ...
                    clickable
                    @click="
                      dv.lispurdocs.isSelectIrc = !dv.lispurdocs.isSelectIrc
                    "
                  >
                    <BAST02D01mini
                      :pComp="dv.lispurdocs.company"
