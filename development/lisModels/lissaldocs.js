...
const signstatSchema = new mongoose.Schema({
  ...
  date: { type: Date, label: "İmza Tarihi", default: new Date() },
});
...
const schema = new mongoose.Schema(
  {
    ...
    docdate: { type: Date, label: "Belge tarihi", default: new Date() },
    validuntil: {
      type: Date,
      label: "Bitiş tarihi",
    ...
    grcbuilding: { type: String, label: "Şehir", default: "" },
    ...
    isstop: { type: Boolean, label: "Durduruldu mu?", default: false },
    //******************* */
