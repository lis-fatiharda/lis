<template>
    <template v-for="note in lisfindoc.notes" :key="note.id">
...
export default {
    ...
    methods: {
        async pushNewNote() {
            let newNote = { ...this.lisfindoc.notes[0] };
            ...
            this.lisfindoc.notes.push(newNote);
        },
        async removeNote(note) {
            this.lisfindoc.notes = [
                ...this.lisfindoc.notes.filter(
                    (e) =>
