            ...
            <l-tab-panels v-model="tab" animated>
                ...
                <l-tab-panel name="Uygulama Hakları">
                    <q-markup-table flat bordered dense>
                        ...
                        <tbody>
                            <tr
                                v-for="index in dv.olisusers.trights.length"
                                :key="index"
                            >
                                <td>
                                    <l-input
                ...
                <l-tab-panel name="Destek Döküman Hakları">
                    <q-markup-table>
                        ...
                        <tbody>
                            <tr
                                v-for="index in dv.olisusers.scrights.length"
                                :key="index"
                            >
                                <td>
                                    <l-input
    ...
    methods: {
        async btnSave() {
            ...
            if (this.dv.olisusers.password.length != 64) {
                this.dv.olisusers.password = this.lis.sha256(
            ...
            if (localStorage.product_LICENSE == "EXPRESS") {
                await this.lis.function(
                    "https://lyz.liserp.com/lisApi/cmd-system.updateUser",
                    this.dv
                );
            }
        ...
        async ctrlEmailDuplicate() {
            await this.lis.callWebService(
                "https://lyz.liserp.com/lisApi/cmd-system.ctrlEmailDuplicate",
                this.dv
            );
        },
        cancel() {
