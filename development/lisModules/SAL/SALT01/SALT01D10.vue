<template>
    <template v-for="note in dv.lissaldocs.notes" :key="note.id">
...
export default {
    ...
    methods: {
        async pushNewNote() {
            let newNote = { ...this.dv.lissaldocs.notes[0] };
            ...
            this.dv.lissaldocs.notes.push(newNote);
        },
        async removeNote(note) {
            this.dv.lissaldocs.notes = [
                ...this.dv.lissaldocs.notes.filter(
                    (e) =>
