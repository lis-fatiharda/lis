<template>
  <l-card style="width: 100%" class="q-pa-xs q-gutter-xs">
    ...
    <div class="q-gutter-xs row">
      <l-input
        ...
        readonly
        dense
        v-model="dv.lispurdocs._createdby"
      />
      <l-datetime
        label="Tarih"
        :readonly="true"
        v-model="dv.lispurdocs.createdAt"
      />
    </div>
    <div class="q-gutter-xs row">
      <l-input
        ...
        readonly
        dense
        v-model="dv.lispurdocs._updatedby"
      />
      <l-datetime
        label="Tarih"
        :readonly="true"
  ...
  <l-card style="width: 100%">
    <l-div>
      ...
      <l-table
        name="SALT01D09"
        v-model="dv.lispurdocs.signstat"
  ...
  <l-card style="width: 100%">
    ...
    <l-card-section class="q-gutter-xs row">
      ...
      <l-select
        label="E-Fatura Tipi"
        width="200px"
        v-model="dv.lispurdocs.einvotype"
        :options="[
        ...
        :readonly="dv.lispurdocs.isprinted == true ? true : false"
      />
    </l-card-section>
  </l-card>
</template>
